...
namespace LMS_Test.Selenium_Tests
{
    ...
    public class StudentRegistrationCourse
    {
        ...
        private string baseUrl = "https://localhost:7270/";
        ...
        public void DropCourse(string courseName)
        {
            ...
            var dropButton = courseCard.FindElement(By.CssSelector(".btn"));

            // Scroll to find button
                new Actions(driver)
                    .ScrollToElement(dropButton)
                    .Perform();
        ...
        public void StudentCanAddCourse()
        {
            ...
            try
            {
                ...
                var courseCard = wait.Until(d => d.FindElements(By.CssSelector(".card"))
                    .FirstOrDefault(c => c.FindElement(By.CssSelector(".card-title")).Text.Contains("TestCourse")));
                ...
                bool courseAdded = courses.Any(c => c.Text.Contains("TestCourse")); 
            ...
            {
                // reset test by dropping course again
                DropCourse("TestCourse");
            }
        }
    }
}